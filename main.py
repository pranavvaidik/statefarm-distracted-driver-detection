...
#direct_train
model.fit(train_tensors, targets_train, 
          validation_data=(valid_tensors, targets_val),
...
test_accuracy = 100*np.sum(np.array(dog_breed_predictions)==np.argmax(targets_test, axis=1))/len(dog_breed_predictions)
